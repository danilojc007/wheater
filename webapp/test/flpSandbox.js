		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "WheaterApp",
									"targetURL": "#wheaterwheater-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"wheaterwheater-display": {
								"semanticObject": "wheaterwheater",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=wheater.wheater",
									"url": sap.ui.require.toUrl("wheater/wheater")
								}
							}
						}
					}
